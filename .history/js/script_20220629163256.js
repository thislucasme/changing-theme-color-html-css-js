...
options.addEventListener("change", function () {
    if (options.value) {
        ...
        if (options.value === "tema-2") {
            document.getElementsByClassName("calculadora-dois").classList.remove("calculadora-dois");
            document.getElementsByClassName("calculadora-dois").classList.add("calculadora");
        }
